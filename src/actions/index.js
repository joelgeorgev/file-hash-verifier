...
export const setHashType = (hashType) => {
  return { type: SET_HASH_TYPE, hashType }
}
export const cancelFileRead = () => {
  return { type: CANCEL_FILE_READ }
}
...
export const saveArrayBuffer = (arrayBuffer) => {
  return { type: SAVE_ARRAYBUFFER, arrayBuffer }
}
export const saveHashType = (hashType) => {
  return { type: SAVE_HASH_TYPE, hashType }
}
export const saveProgress = (progress) => {
  return { type: SAVE_PROGRESS, progress }
}
export const saveLoading = (loading) => {
  return { type: SAVE_LOADING, loading }
}
export const saveHash = (hash) => {
  return { type: SAVE_HASH, hash }
}
